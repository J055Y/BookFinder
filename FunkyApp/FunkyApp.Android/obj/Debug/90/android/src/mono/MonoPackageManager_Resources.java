...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "FunkyApp.Android.dll" comes first in this list. */
		"FunkyApp.Android.dll",
		"FormsViewGroup.dll",
		"FunkyApp.dll",
		...
		"Xamarin.Firebase.ML.Common.dll",
		"Xamarin.Firebase.ML.Vision.dll",
		...
		"Xamarin.GooglePlayServices.Vision.ImageLabel.dll",
	};
