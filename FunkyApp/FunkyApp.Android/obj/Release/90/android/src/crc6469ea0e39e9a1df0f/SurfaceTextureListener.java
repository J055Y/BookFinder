...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FunkyApp.Droid.SurfaceTextureListener, FunkyApp.Android", SurfaceTextureListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SurfaceTextureListener.class)
			mono.android.TypeManager.Activate ("FunkyApp.Droid.SurfaceTextureListener, FunkyApp.Android", "", this, new java.lang.Object[] {  });
	}

	public SurfaceTextureListener (crc6469ea0e39e9a1df0f.CameraFragment p0)
	{
		super ();
		if (getClass () == SurfaceTextureListener.class)
			mono.android.TypeManager.Activate ("FunkyApp.Droid.SurfaceTextureListener, FunkyApp.Android", "FunkyApp.Droid.CameraFragment, FunkyApp.Android", this, new java.lang.Object[] { p0 });
	}
